...
| 05 — Backend и инфраструктура | Supabase, Storage, RLS, Vercel, Modal, auth, расходы | Production и Auth работают; очередь и Storage подключены | Зафиксировать полную схему БД, CI, ошибки и бюджетные лимиты |
