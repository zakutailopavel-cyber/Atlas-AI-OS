...
export async function POST(req: Request) {
  ...
  try {
    ...
    const r = await openai.responses.create({
      ...
      instructions:
        "Ты — контент-стратег Atlas AI OS. Создай целостную неделю контента на русском языке. Все 7 публикаций должны отличаться по углу, задаче и формату, но развивать текущую сюжетную линию персонажа. Строго соблюдай биографию, неизменяемые факты, словарь, ценности, бренды и запрещённые темы из памяти модели. Не повторяй идеи из переданной истории. Визуальные промпты пиши на английском, строго сохраняя внешность цифровой модели. Хэштеги возвращай с #.",
